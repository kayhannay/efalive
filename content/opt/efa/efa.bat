...
command.com /e:1024 /cefa.bat run %1 %2 %3 %4 %5 %6 %7 %8
GOTO ENDE

:WINNT
echo Betriebssystem: Windows NT
call efa.bat run %1 %2 %3 %4 %5 %6 %7 %8
GOTO ENDE
...
REM JVM Options
SET JVMOPTIONS=-Xmx%EFA_JAVA_HEAP% -XX:NewSize=%EFA_NEW_SIZE% -XX:MaxNewSize=%EFA_NEW_SIZE% -XX:+PrintGCTimeStamps -XX:+PrintGCDetails -Xloggc:efa.gc -verbose:gc
ECHO JVMOPTIONS=%JVMOPTIONS%

REM Java Arguments
SET EFA_JAVA_ARGUMENTS=%JVMOPTIONS% -cp %CP% de.nmichael.efa.Efa %2 %3 %4 %5 %6 %7 %8 %9
