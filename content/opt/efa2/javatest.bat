...
echo Folgende Java-Version ist installiert (mind. v1.5.0 benoetigt):
echo The following Java Version in installed (at least v1.5.0 required):
echo ============================= JAVA VERSION =============================
java -version
echo ========================================================================
echo.
...
echo Falls kein Java oder eine Version aelter als v1.5.0 installiert ist,
...
echo If you don't have Java installed, of if your version is older than v1.5.0,
